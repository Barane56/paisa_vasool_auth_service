...
class DisputeMemoryEpisode(Base):
    ...
    open_questions_asked    = relationship("DisputeOpenQuestion", back_populates="asked_episode",    foreign_keys="DisputeOpenQuestion.asked_in_episode_id",    lazy="select")
    open_questions_answered = relationship("DisputeOpenQuestion", back_populates="answered_episode", foreign_keys="DisputeOpenQuestion.answered_in_episode_id", lazy="select")
